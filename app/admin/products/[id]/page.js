        ...
        <>
            ...
            <div className="product-detail-container">
                ...
                <form onSubmit={handleSubmit} className="product-form">
                    ...
                    <input type="number" name="sell_price" value={formData.sell_price} onChange={handleChange} required />

                    <label>Thumbnail One:</label>
                    <ImageUploader
                        name="thumbnail_one"
                        onImageUpload={(images) => handleImageUpload("thumbnail_one", images[0])}
                    />

                    <label>Thumbnail Two:</label>
                    <ImageUploader
                        name="thumbnail_two"
                        onImageUpload={(images) => handleImageUpload("thumbnail_two", images[0])}
                    />
                    ...
                    <ImageUploader
                        name="other_images"
                        multimage={true}
                        onImageUpload={(images) => handleImageUpload("other_images", images)}
                    />
