...
import '@/public/assets/css/new/PrivacyPolicy.css'; // External CSS for styling
    ...
    <Layout headerStyle={1} footerStyle={1}>
      <div className="privacy-policy-container">
        ...
        <section className="policy-section">
          <p>
            This Privacy Policy describes how (M/s. Kesari Turtle Engineers / Ketu Engineers) (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from www.kesariturtleengineers.in (the "Site") or otherwise communicate with us (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.
          </p>
          <p>
        ...
        <section className="policy-section">
          ...
          <h3>1. Information We Collect Directly from You</h3>
          <p>
          Information that you directly submit to us through our Services may include:
          </p>
          <ul>
            <li><strong>Basic contact details :</strong>including your name, address, phone number, email.</li>
            <li><strong>Order details:</strong> including your name, billing address, shipping address, payment confirmation, email address, phone number.</li>
          ...
          <h3>2. Information We Collect through Cookies</h3>
          <p>
          ...
          <ul>
            <li>Companies who support our Site and Services, such as Godaddy.</li>
        ...
        <section className="policy-section">
          <h2>Cookies</h2>
          <p>
          Like many websites, we use Cookies on our Site. For specific information about the Cookies that we use related to powering our store with Godaddy, see https://www.Godaddy.com/legal/cookies. We use Cookies to power and improve our Site and our Services (including to remember your actions and preferences), to run analytics and better understand user interaction with the Services (in our legitimate interests to administer, improve and optimize the Services). We may also permit third parties and services providers to use Cookies on our Site to better tailor the services, products and advertising on our Site and other websites.
          </p>
          <p>
        ...
        <section className="policy-section">
          ...
          <ul>
            ...
            <li>With business and marketing partners, including Godaddy, to provide services and advertise to you. Our business and marketing partners will use your information in accordance with their own privacy notices.</li>
        ...
        <section className="policy-section">
          ...
          <ul>
            ...
            <li><strong>Right to Delete:</strong> You may have a right to request that we correct inaccurate personal information we maintain about you.</li>
