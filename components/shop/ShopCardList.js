                    ...
                    <div className="tpproduct__thumb">
                        <div className="tpproduct__thumbitem p-relative">
                            <Link href="/shop-details">
                                <img src={`/assets/img/product/${item.thumbnail[0]}`} alt="product-thumb" />
                                <img className="thumbitem-secondary" src={`/assets/img/product/${item.thumbnail[1]}`} alt="product-thumb" />
                            </Link>
                        </div>
                    </div>
                </div>
